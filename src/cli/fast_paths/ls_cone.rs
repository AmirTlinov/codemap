// Responsibility: cli-fast-paths-ls-cone
use crate::cli::{
    CommandKind, ConeArgs, LsArgs, accept_depth_compat, cone_section_name,
    lens_cache_matches_current, ls_section_name, output_format_with_json_alias,
    output_with_prelude, root_relative_arg, set_cached_map_snapshot,
};
