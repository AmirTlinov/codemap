// Responsibility: map-proof-commands
use crate::map::{
    domain_for_path, find_script, impact_report, is_support_artifact_path,
    javascript_package_has_script, javascript_runner_for_package, package_for_rel,
    package_minimal_command, proof_surface_command_closes_fallback, shell_quote,
    split_symbol_anchor, unique, verification_plan,
};
...
pub(crate) fn proof_fallback_commands(
    project: &Project,
    anchors: &[String],
    changed: &[String],
    proofs: &[ProofSurface],
...
pub(crate) fn anchor_file_rel(anchor: &str) -> String {
