...
pub(crate) fn sort_edges(edges: &mut Vec<StructuralEdge>) {
    edges.sort_by(|a, b| {
        a.from
            .cmp(&b.from)
...
pub(crate) fn balanced_edge_prefix_by_source(
...
pub(crate) fn limit_edge_section(
...
pub(crate) fn directory_has_files(project: &Project, rel: &str) -> bool {
    if rel == "." {
...
pub(crate) fn parent_anchor_for_missing(rel: &str) -> String {
    Path::new(rel)
        .parent()
...
pub(crate) fn files_under_directory<'a>(project: &'a Project, rel: &str) -> Vec<&'a FileInfo> {
...
pub(crate) fn direct_files_under_directory<'a>(
    project: &'a Project,
    rel: &str,
) -> Vec<&'a FileInfo> {
    project
...
pub(crate) fn immediate_child_dirs(project: &Project, rel: &str) -> Vec<String> {
...
pub(crate) fn directory_role_surface(project: &Project, dir: &str) -> Option<String> {
...
pub(crate) fn directory_container_role_surface(project: &Project, dir: &str) -> Option<String> {
