// Responsibility: diff-map-lens-unknowns
use crate::map::{
    dynamic_env_lookup_line, dynamic_import_line, dynamic_require_line, raw_sql_literal_line,
    route_dynamic_method_line, route_dynamic_path_line, route_string_concat_line, shell_quote,
    unknown, unsupported_framework_route_line,
};
use crate::model::Unknown;
use std::collections::BTreeSet;

pub(crate) fn unknown_from_added_line(
    rel: &str,
    line: usize,
    text: &str,
