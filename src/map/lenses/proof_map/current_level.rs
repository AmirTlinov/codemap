// Responsibility: proof-map-lens-current-level
use crate::map::{
    directory_container_role_surface, files_under_directory, immediate_child_dirs, proof_surface,
};
use crate::model::{EvidenceLocation, EvidenceStrength, FileInfo, Project, ProofSurface};

pub(crate) fn proof_map_current_level_containers(
    project: &Project,
    scope: Option<&str>,
    raw_sensors: bool,
