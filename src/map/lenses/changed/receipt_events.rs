// Responsibility: changed-lens-receipt-events
use crate::map::{
    DiffMapMode, changed_fact_event, changed_map_path_file_name, diff_base_file_text,
    diff_current_file_text, json_key_line, shell_quote,
};
use crate::model::Project;
use std::collections::BTreeMap;
use std::collections::BTreeSet;

pub(crate) fn changed_receipt_witness_events(
    project: &Project,
    rel: &str,
    mode: &DiffMapMode,
...
pub(crate) fn changed_receipt_witness_surface(project: &Project, rel: &str) -> bool {
    project
        .files
        .get(rel)
...
fn receipt_bucket_values(value: &serde_json::Value, text: &str) -> BTreeMap<String, ReceiptBucket> {
...
fn receipt_bucket_for_key(key: &str) -> Option<&'static str> {
    ...
    match normalized.as_str() {
        ...
        "metrics" | "metric" | "measurements" | "scores" | "results" | "summary" => Some("metrics"),
