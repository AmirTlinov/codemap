// Responsibility: changed-lens-truth
use crate::map::{
    changed_lens_path_looks_like_source, changed_lockfiles_for_manifest,
    changed_manifest_for_lockfile, changed_path_is_generated, changed_path_is_instruction_file,
    changed_path_is_large_binary, changed_path_is_model_weight_like,
    changed_path_is_protected_looking, changed_path_is_runner_like,
    changed_runner_has_package_script, changed_self_selector_suffix,
};
use crate::model::{
    ChangedCouplingFact, ChangedRisk, EvidenceLocation, GitChange, Project, ProofMapReport, Surface,
};
use crate::repo;
use std::collections::BTreeSet;

pub(crate) fn changed_risks(
    project: &Project,
    ...
    push_changed_risk(
        ...
        "medium",
        changed_missing_direct_paths(proof_map)
            .into_iter()
            .collect(),
