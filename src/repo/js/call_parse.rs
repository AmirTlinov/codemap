// Responsibility: repo-js-call-parse
use crate::repo::{
    js_identifier_boundary_before, js_regex_literal_can_start, js_regex_literal_end,
    skip_js_whitespace,
};

pub(crate) struct JsCallSpan {
    pub(crate) source: String,
    pub(crate) start: usize,
    pub(crate) end: usize,
}

pub(crate) fn js_call_spans_with_end(text: &str, callee: &str) -> Vec<JsCallSpan> {
...
pub(crate) fn js_byte_is_inside_string_or_regex_literal(text: &str, byte: usize) -> bool {
...
pub(crate) fn js_balanced_call_end(text: &str, open_paren: usize) -> Option<usize> {
...
pub(crate) fn js_top_level_arguments(call: &str) -> Vec<String> {
...
pub(crate) fn js_split_top_level_commas(value: &str) -> Vec<String> {
