// Responsibility: repo-js-imports
use crate::model::ImportBindingsBySpec;
use crate::repo::{
    JsScanState, collect_js_named_import_bindings, js_export_from_re, js_keyword_positions,
    js_reexport_statement_re, js_regex_literal_can_start, js_regex_literal_end,
    js_static_import_statement_re, parse_js_import_clause_bindings, skip_ascii_whitespace,
    strip_js_comments_from_text,
};
use std::collections::BTreeMap;
use std::collections::BTreeSet;

#[derive(Debug, Clone)]
pub(crate) struct JsStaticImport {
    pub(crate) spec: String,
    pub(crate) clause: Option<String>,
    pub(crate) is_type: bool,
}

pub(crate) fn extract_js_import_specs(text: &str) -> BTreeSet<String> {
...
pub(crate) fn extract_js_static_imports(text: &str) -> Vec<JsStaticImport> {
