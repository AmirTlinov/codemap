// Responsibility: repo-playwright-roles
use crate::repo::{
    SurfaceExtraction, add_accessible_role_name_surface, first_identifier, js_balanced_call_end,
    js_byte_is_inside_string_or_regex_literal, js_call_spans_with_end,
    js_identifier_boundary_after, js_identifier_boundary_before,
    js_plain_object_single_string_property_value, js_split_top_level_commas,
    js_string_literal_value, js_top_level_arguments, normalize_accessible_role, skip_js_whitespace,
};
use std::collections::BTreeMap;
use std::collections::BTreeSet;

pub(crate) fn add_playwright_role_name_surfaces(
