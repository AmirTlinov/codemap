// Responsibility: repo-components-render-analysis
use crate::repo::{
    js_arrow_params_re, js_function_params_re, js_identifier_boundary_after,
    js_identifier_boundary_before, js_labelledby_local_binding_re, js_split_top_level_commas,
};

#[derive(Debug)]
pub(crate) struct ComponentSignature {
    pub(crate) params: String,
    pub(crate) block_open: Option<usize>,
    pub(crate) expression_start: Option<usize>,
}

pub(crate) fn component_signature(body: &str) -> Option<ComponentSignature> {
...
pub(crate) fn skip_js_whitespace(text: &str, mut cursor: usize) -> usize {
...
pub(crate) fn component_direct_render_texts(
    body: &str,
...
pub(crate) fn params_destructure_direct_shorthand_prop(params: &str, prop: &str) -> bool {
...
pub(crate) fn js_first_balanced_object_span(value: &str) -> Option<(usize, usize)> {
...
pub(crate) fn js_destructure_part_is_direct_shorthand_prop(part: &str, prop: &str) -> bool {
...
pub(crate) fn component_body_shadows_labelledby(body: &str) -> bool {
