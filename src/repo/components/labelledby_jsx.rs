// Responsibility: repo-components-labelledby-jsx
use crate::repo::{
    JsxOpeningTagSpan, SurfaceExtraction, add_accessible_name_surface_from_label_in_opening_scope,
    find_jsx_closing_tag_start, js_identifier_boundary_after, jsx_accessible_role_for_opening,
    jsx_opening_has_spread_attr, jsx_opening_tag_spans, jsx_single_exact_static_attr_value,
    skip_js_whitespace, strip_js_comments_from_text,
};
use std::collections::BTreeMap;
use std::collections::BTreeSet;

pub(crate) fn jsx_opening_has_dialog_labelledby_attrs(opening: &JsxOpeningTagSpan) -> bool {
...
pub(crate) fn jsx_element_body_has_exact_expression(
    render_text: &str,
...
pub(crate) fn accessible_name_surfaces_from_component_labelled_ids(
    text: &str,
