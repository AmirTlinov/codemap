// Responsibility: repo-resolution-paths
use crate::model::PackageInfo;
use crate::repo::{
    TsPathAlias, match_pattern_wildcard, normalize_rel_path, package_public_target_candidates,
    package_target_path, resolve_go, resolve_python, resolve_rust, resolve_ts_path_alias,
    ts_alias_applies_to_importer, unique_strings,
};
...
pub(crate) fn resolve_path_like(base: &str, paths: &BTreeSet<String>) -> Option<String> {
